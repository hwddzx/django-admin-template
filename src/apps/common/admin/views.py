...
from django.db.models import Q, DateTimeField, DateField, IntegerField
...
class AjaxFormsetEditView(AjaxLoginRequiredMixin, ModalShowMixin, RequestAwareMixin, ContextMixin, View):
    ...
    form_column_count = 3
    nested_model_verbose_name = ''
    master_model_verbose_name = ''
    ...
    def get(self, request, *args, **kwargs):
        ...
        for source in self.get_related_sources(self.object):
            ...
            builders.append({'datatables_builder': source['builder_class'],
                             'datatables_list_url': reverse(source['datatable_list_name'],
                ...
                if not search_expr:
                    ...
                    for expr in search_expr:
                        ...
                        if q is None:
                            ...
                            q |= Q(**e)
                    q_list.append(q)
                elif type(search_expr) is FunctionType:
...
class ExcelBuilderMixIn(object):
    ...
    def get_row_data(self, model, form):
        ...
        for form_field in form:
            try:
                model_field = form._meta.model._meta.get_field_by_name(form_field.name)[0]
                ...
                elif isinstance(model_field, DateField) or \
