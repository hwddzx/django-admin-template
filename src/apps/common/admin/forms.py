...
from django.db.models import ManyToManyField, DateField, BooleanField, IntegerField, FileField
...
class ModelDetail(DisplayCreatorOwnerMixin, object):
    ...
    def _fields_for_model(self):
        if hasattr(self._meta['model']._meta, '_name_map'):
            ...
            meta_fields = self._meta['model']._meta.fields
            if self._meta['excludes']:
